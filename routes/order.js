     ...
     if (userid !== null && userid > 0) {
        database.table('orders')
            .insert({
               ...
               // console.log('new order',newOrderId.insertId)
...
//Get Order Details
// router.get('/:odrId', (req, res) => {
//     let orderId = req.params.odrId;
//     database.table('orders_details as c')
//         .join([
//             {
//                 table: "orders as v",
//                 on: `v.id = c.order_id`
